  ...
  module Generators
    class ConcernsGenerator < Develoz::Generators::Base
      ...
      def create_migrations
        template "db/migrate/add_status_transitions.rb.tt", "db/migrate/add_status_transitions.rb"
        template "db/migrate/create_configurations.rb.tt", "db/migrate/create_configurations.rb"
      end
