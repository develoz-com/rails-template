...
| bin/run (T18) | develoz-com/agent | `bin/run` | `spec/fixtures/canonical/develoz-com-agent/bin/run` | `lib/generators/develoz/docker/templates/bin_run.tt` | verbatim |
...
| ci lint Rakefile (F1) | LooperInsights/looper_core | `Rakefile` | `spec/fixtures/canonical/LooperInsights-looper_core/Rakefile` | `lib/generators/develoz/ci/templates/Rakefile.tt` | verbatim |
| tooling constants (F1) | LooperInsights/looper_core | `config/constants.rb` | `spec/fixtures/canonical/LooperInsights-looper_core/config/constants.rb` | `lib/generators/develoz/tooling/templates/constants.rb.tt` | Constants namespace, app_name/app_class, minimal illustrative set |
...
| docs_render (T19) | LooperInsights/looper_core | `app/controllers/docs_controller.rb` | `spec/fixtures/canonical/LooperInsights-looper_core/app/controllers/docs_controller.rb` | `lib/generators/develoz/docs_render/templates/app/controllers/docs_controller.rb.tt` | adapted (AdminController -> ApplicationController) |
